...
const APPS = {
  patient: {
    ...
    seeds: [
      ...
      // "ask the doctor": the chat opens with a notebook entry attached (approved entries only)
      "/patient/chat/chat-1?record=rec-13",
      "/patient/chat/new?with=doc-2&record=rec-4",
  ...
  admin: {
    ...
    seeds: [
      ...
      "/admin",
      "/admin/applications",
      "/admin/applications/doc-15",
      "/admin/applications/doc-18",
      "/admin/doctors",
      "/admin/doctors/doc-1",
      "/admin/reviews",
      "/admin/users",
