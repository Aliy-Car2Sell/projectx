...
**Topilma, tuzatilmagan (so'ralmagan):** `--color-primary` `#1a9be6` oq fonda matn sifatida **3.05:1** — havolalar va ko'k sarlavhalar uchun AA'dan past. Bu brend rangi, alohida qaror kerak (masalan matn uchun to'qroq `primary-text` tokeni).
